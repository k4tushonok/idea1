...
BATCH_EVAL_SIZE: int = 10                # Размер батча для групповых LLM-запросов при оценке
...
GENERATION_METRICS = [
    ...
    {"name": "meteor",            "weight": 0.30, "stage": 1},
]
METRICS_CONFIG = SQUAD_METRICS
METRIC_WEIGHTS: dict = {m["name"]: m["weight"] for m in SQUAD_METRICS}
