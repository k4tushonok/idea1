...
LOCAL_CANDIDATES_PER_ITERATION: int = 2  # Сколько вариантов генерируем за одну итерацию
LOCAL_BATCH_SIZE: int = 8                # Максимальное число failure-примеров в одном батче
LOCAL_MAX_EXAMPLES: int = 50             # Максимальное число примеров, передаваемых в один LLM-вызов
LOCAL_PARENTS_PER_ITERATION: int = 1     # Сколько лучших узлов использовать как «родителей»
