...
MAX_TOKENS: int = 3500                   # Максимальное число токенов
PROVIDER = "local_qwen"                  # Провайдер LLM
API_KEY = ""                             # Ключ API провайдера
MODEL = "Qwen/Qwen2.5-1.5B-Instruct"     # Модель LLM
...
MAX_EXAMPLES_PER_NODE: int = 30          # Максимальное число примеров на узел
