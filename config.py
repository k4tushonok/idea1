...
LOCAL_CANDIDATES_PER_ITERATION: int = 3  # Сколько вариантов генерируем за одну итерацию
...
GLOBAL_QUALITY_GATE_TOLERANCE: float = 0.9 # Допуск порога качества для глобального исследования
GLOBAL_PRESCREEN_GATE: float = 0.85      # Глобальные кандидаты должны набрать >= этой доли от лучшего
